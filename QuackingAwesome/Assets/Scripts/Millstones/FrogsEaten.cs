...
public class FrogsEaten : MonoBehaviour
{
    private int state = 0;
    ...
    void Start()
    {
        explanation.text = "Eat " + _goals[state] + " frogs" ;
    ...
    void Update()
    {
        ...
        _progression = GlobalControl.Instance.savedGame.savedMillstonesData.frogsEaten;
