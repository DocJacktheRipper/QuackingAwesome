...
public class BeaverScared : MonoBehaviour
{
    private int state = 0;
    private int _progression;
    private readonly int[] _goals = {1, 5, 15};
    ...
    void Start()
    {
        explanation.text = "Scare away " + _goals[state] + " beavers";
    ...
    void Update()
    {
        ...
        _progression = GlobalControl.Instance.savedGame.savedMillstonesData.beaverScared;
